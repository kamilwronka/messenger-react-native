      ...
      return (
          <View style={{ flex: 1, backgroundColor: '#ffffff', flexDirection: 'column', flexGrow: 1 }}>
              <Header>
                  ...
                  <HeaderIcon onPress={this.goToSearchScreen}>
                      {/*<Feather name="search" size={18} color="#912F56" />*/}
                  </HeaderIcon>
              </Header>
              <SearchHeader />
              <ScrollView
                  refreshControl={
                      <RefreshControl refreshing={this.props.friends.fetching} onRefresh={this._onRefresh} />
                  }>
                  <FlatList
                      style={{ width: '100%' }}
